...
<template>
  <div
    class="flex flex-col justify-center items-center text-center gap-5 md:gap-10 sm:min-w-[600px] m-5 px-5 py-10 rounded-sm transform -translate-y-25 bg-white/90 shadow-sm"
  >
